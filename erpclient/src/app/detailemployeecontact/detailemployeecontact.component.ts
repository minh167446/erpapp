...
@Component({
  selector: 'app-detailemployeecontact',
  templateUrl: './detailemployeecontact.component.html',
  styleUrls: ['./detailemployeecontact.component.css']
})
export class DetailemployeecontactComponent implements OnInit {
