...
@Component({
  selector: 'app-detailemployeemature',
  templateUrl: './detailemployeemature.component.html',
  styleUrls: ['./detailemployeemature.component.css']
})
export class DetailemployeematureComponent implements OnInit {
